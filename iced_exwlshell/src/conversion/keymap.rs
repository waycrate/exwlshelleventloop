...
pub fn key(key: exwlshellev::keyboard::Key) -> iced_core::keyboard::Key {
    ...
    match key {
        ...
        exwlshellev::keyboard::Key::Character(c) => {
            keyboard::Key::Character(smol_str::SmolStr::from(c.to_string()))
        }
        // Hyper and Super are deprecated
        #[allow(deprecated)]
        exwlshellev::keyboard::Key::Named(named_key) => keyboard::Key::Named(match named_key {
...
pub fn physical_key(
    physical_key: exwlshellev::keyboard::PhysicalKey,
) -> iced_core::keyboard::key::Physical {
    use iced_core::keyboard;
    match physical_key {
        exwlshellev::keyboard::PhysicalKey::Code(code) => {
        ...
        exwlshellev::keyboard::PhysicalKey::Unidentified(code) => {
...
/// [`winit`]: https://github.com/rust-windowing/winit
/// [`iced`]: https://github.com/iced-rs/iced/tree/0.12
pub fn key_code(key_code: exwlshellev::keyboard::KeyCode) -> Option<keyboard::key::Code> {
    use exwlshellev::keyboard::KeyCode;
...
pub fn native_key_code(
    native_key_code: exwlshellev::keyboard::NativeKeyCode,
) -> keyboard::key::NativeCode {
    use exwlshellev::keyboard::NativeKeyCode;
